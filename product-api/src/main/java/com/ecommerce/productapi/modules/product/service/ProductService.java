package com.ecommerce.productapi.modules.product.service;

import static com.ecommerce.productapi.config.RequestUtil.getCurrentRequest;
import static com.ecommerce.productapi.modules.sales.enums.SalesStatus.APPROVED;
import static com.ecommerce.productapi.modules.sales.enums.SalesStatus.REJECTED;
...
import com.ecommerce.productapi.modules.category.service.CategoryService;
import com.ecommerce.productapi.modules.product.dto.ProductCheckStockRequest;
import com.ecommerce.productapi.modules.product.dto.ProductQuantityDTO;
...
import com.ecommerce.productapi.modules.product.dto.ProductStockDTO;
import com.ecommerce.productapi.modules.product.model.Product;
import com.ecommerce.productapi.modules.product.repository.ProductRepository;
import com.ecommerce.productapi.modules.sales.client.SalesClient;
import com.ecommerce.productapi.modules.sales.dto.SalesConfirmationDTO;
import com.ecommerce.productapi.modules.sales.dto.SalesProductResponse;
import com.ecommerce.productapi.modules.sales.rabbitmq.SalesConfirmationSender;
...
public class ProductService {
    ...
    public void updateProductStock(ProductStockDTO product) {
        try {
            ...
            var rejectedMessage = new SalesConfirmationDTO(product.getSalesId(), REJECTED, product.getTransactionid());
    ...
    private void updateStock(ProductStockDTO product) {
        ...
        if (!isEmpty(productsForUpdate)) {
            ...
            var approvedMessage = new SalesConfirmationDTO(product.getSalesId(), APPROVED, product.getTransactionid());
